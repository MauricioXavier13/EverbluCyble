...
EspMQTTClient mqtt(
  "MEO-CA232D",     // Your Wifi SSID
  "FBC8097A37",     // Your WiFi key
  "192.168.1.186",  // MQTT Broker server ip
  "godeepbroker",   // Can be omitted if not needed
  "godeep1026!",    // Can be omitted if not needed
